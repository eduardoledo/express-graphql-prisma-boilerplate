...
export namespace Prisma {
  ...
  */
  ...
  export type AggregateRefreshToken = {
    ...
    avg: RefreshTokenAvgAggregateOutputType | null
    _sum: RefreshTokenSumAggregateOutputType | null
    sum: RefreshTokenSumAggregateOutputType | null
  ...
  export type RefreshTokenAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<RefreshTokenOrderByInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
    ...
    **/
     ...
     * @deprecated since 2.23.0 please use `_avg`
    **/
    avg?: RefreshTokenAvgAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to sum
    **/
     ...
     * @deprecated since 2.23.0 please use `_sum`
    **/
    sum?: RefreshTokenSumAggregateInputType
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
     * 
     * Select which fields to find the minimum value
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]: 
        ...
        ? Array < PermissionGetPayload<S['include'][P]>>  : never
  } 
    : 'select' extends U
    ? {
  ...
  : 
        ...
        P extends 'permissions'
        ? Array < PermissionGetPayload<S['select'][P]>>  : never
  } 
    : User
  : User
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    tokens<T extends RefreshTokenFindManyArgs = {}>(args?: Subset<T, RefreshTokenFindManyArgs>): CheckSelect<T, PrismaPromise<Array<RefreshToken>>, PrismaPromise<Array<RefreshTokenGetPayload<T>>>>;
  ...
  export type RefreshTokenUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<RefreshTokenUpdateManyMutationInput, RefreshTokenUncheckedUpdateManyWithoutTokensInput>
  }
  ...
  export type RefreshTokenUncheckedUpdateManyWithoutTokensInput = {
    id?: IntFieldUpdateOperationsInput | number
    token?: StringFieldUpdateOperationsInput | string
    valid?: BoolFieldUpdateOperationsInput | boolean
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
